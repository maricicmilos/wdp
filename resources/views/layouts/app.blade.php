        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <i class="fas fa-home"></i>
                    <span>Web Development Portal</span></a>
            </li>
                ...
                <div id="users" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('users.create') }}"><i
                                class="fas fa-user-plus">&nbsp;&nbsp;&nbsp;Add
                                User</i></a>
                        <a class="collapse-item" href="{{route('users.search', ['action' => 'edit'])}}"><i
                                class="fas fa-user-edit">&nbsp;&nbsp;&nbsp;Edit User</i></a>
                        <a class="collapse-item" href="{{route('users.search', ['action' => 'delete'])}}"><i
                                class="fas fa-user-minus">&nbsp;&nbsp;&nbsp;Delete User</i></a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{url('/images/'. Auth::user()->avatar)}}">
                            </a>
